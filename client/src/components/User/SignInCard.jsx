...
const Card = styled(MuiCard)(({ theme }) => ({
    ...
    alignSelf: 'center',
    width: '100%',
    minHeight: '500px', // Ensures height is consistent
...
export default function SignInCard() {
  ...
  return (
    <Card variant="outlined">
      ...
      >
        <FormControl>
          <FormLabel htmlFor="email" sx={{ color: '#AAB4BE' }}>Email</FormLabel>
          <TextField
            error={emailError}
        ...
        <FormControl>
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            <FormLabel htmlFor="password" sx={{ color: '#AAB4BE' }}>Password</FormLabel>
            <Link
              component="button"
              type="button"
