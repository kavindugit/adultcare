...
export default function Report() {
  ...
  return (
    <Card variant="outlined">
      ...
      <form onSubmit={OnSubmitHandler} style={{ display: 'grid',flexDirection: 'column', width: '100%', gap: '16px' }}>
        {[
          { label: 'Note', id: 'fullName', placeholder: 'Latest Note' },
          { label: 'Date of Note', id: 'dob', placeholder: 'YYYY-MM-DD', type: 'date' },
          { label: 'Prescription', id: 'fullName', placeholder: 'Latest prescription' },
          { label: 'Date of prescription', id: 'dob', placeholder: 'YYYY-MM-DD', type: 'date' },
