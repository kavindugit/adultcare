...
const AdminSessionTable = () => {
  ...
  // Get card color based on session type
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            >
              <Link 
                to="/createForm" 
                className="bg-white text-blue-700 hover:bg-blue-50 transition flex items-center px-4 py-2 rounded-lg font-medium shadow-md"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 flex items-center shadow-sm">
              ...
              <div>
                <p className="text-sm font-medium text-blue-100">Session Types</p>
                <p className="text-2xl font-bold">{sessionTypes.length - 1}</p>
              </div>
            </div>
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 flex items-center shadow-sm">
              ...
              <div>
                <p className="text-sm font-medium text-blue-100">Latest Update</p>
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 mb-8 flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button 
              ...
              className="bg-blue-50 text-blue-600 hover:bg-blue-100 transition p-2 rounded-lg"
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map(i => (
              <div key={i} className="bg-white border border-gray-200 rounded-xl p-5 shadow animate-pulse">
                ...
                >
                  <div className="p-5">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-white/70 text-gray-700 backdrop-blur-sm">
                        {session.sessionType}
                      </span>
                      <div className="text-gray-500 text-sm">
                        ID: {session._id.substring(0, 6)}...
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center text-gray-600">
                        ...
                        <span>{session.sessionTime} • {session.sessionDuration}</span>
                      </div>
                      
                      <div className="flex items-center text-gray-800 font-medium">
                        <DollarSign size={16} className="mr-2 flex-shrink-0" />
                        <span>Rs. {session.sessionPrice.toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between border-t border-gray-200/50 bg-white/50 px-5 py-3">
                    <button 
                      ...
                      className="text-blue-600 hover:text-blue-800 transition flex items-center text-sm font-medium"
                    >
                    ...
                    <button 
                      ...
                      className="text-red-600 hover:text-red-800 transition flex items-center text-sm font-medium"
                    >
          ...
          <div className="bg-white rounded-xl shadow p-10 text-center">
            ...
            <div className="flex justify-center">
              <Link 
                to="/createForm" 
                className="bg-blue-600 text-white hover:bg-blue-700 transition flex items-center px-4 py-2 rounded-lg font-medium"
              >
                <Plus size={18} className="mr-2" />
                Add New Session
              </Link>
              {(searchTerm || selectedType !== "All") && (
                <button 
                  ...
                  className="ml-3 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition"
                >
                  Reset Filters
                </button>
              )}
